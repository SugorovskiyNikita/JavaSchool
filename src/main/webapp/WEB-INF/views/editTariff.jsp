    ...
    <div class="row">
        <div class="col-sm-4">
            ...
            <ul class="list-group">
                ...
                <input class="form-control" type="text" name="name" placeholder="Name of tariff" value="${tariff.name}">
                <input class="form-control" type="number" name="cost" placeholder="Cost" value="${tariff.cost}">
                <input class="form-control" type="text" name="description" placeholder="Description" value="${tariff.description}">
            </ul>
        </div>
                <div class="col-sm-4">
