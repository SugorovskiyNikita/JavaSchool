...
<div class="container target">
    <div class="row">
        <div class="col-sm-12">
            ...
            <button type="button" class="btn btn-info"> <a  style="color: #F4EEE8;" href="/admin/customers">Return to all customers</a></button>
        </div>
    ...
    <div class="row">
        <div class="col-sm-3">
            ...
            <ul class="list-group">
                ...
                <li class="list-group-item text-right"><span class="pull-left"><strong class="">Birthday: </strong></span><fmt:formatDate value="${customer.dateOfBirth}" pattern="dd-MM-yyyy" /></li>
        ...
        <div class="table-responsive">
                ...
                <c:forEach var="contract" items="${customer.contracts}">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <button type="button" class="btn btn-success btn-sm"><a class="inline-link-unlock" title="Unblock contract" style="color: #ebebeb;" href="#"
                                ...
                                <button type="button" class="btn btn-danger btn-sm"><a class="inline-link-lock" title="Block contract" style="color: #ebebeb;" href="#"
            ...
            <button type="button" class="btn btn-success"><a class="inline-link-unlock" title="Unblock contract" style="color: #ebebeb;" href="#"
                                                                    onclick="document.forms['unblock${customer.id}'].submit()">Unblock customer</a>
                </form:form>
                </c:when>
                <c:otherwise>
                ...
                <form:form id="block${customer.id}" method="POST"
                           ...
                           enctype="application/x-www-form-urlencoded">
                <input type="text" hidden name="customerId" value=${customer.id}>
                <button type="button" class="btn btn-danger"><a class="inline-link-lock" title="Block contract" style="color: #ebebeb;" href="#"
                                                                       onclick="document.forms['block${customer.id}'].submit()">Block customer</a>
                    </form:form>
                    </c:otherwise>
                    </c:choose>
            </div>
