...
<div class="container-fluid">
    <form name="option" action="/admin/addOption" method="post">
        ...
        <fieldset class="form-group">
            ...
            <input type="text" class="form-control" name="connectCost" placeholder="Cost connection for option"
                   id="connectCost"
                   required pattern=\d+(\.\d{2})?>
        </fieldset>
        <fieldset class="form-group">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="panel-body boxes">
                    <div class="controls">
                        <select required id="forTariffs" style="width: 100%" name="forTariffs" multiple="multiple"
                                onchange="this.value">
                ...
                <div class="panel-body boxes">
                    <div class="controls">
                        <select id="requiredFrom" style="width: 100%" name="requiredFrom"
                                class="js-example-basic-multiple" multiple="multiple" onchange="this.value">
                ...
                <div class="panel-body boxes">
                    <div class="controls">
                        <select id="forbiddenWith" style="width: 100%" name="forbiddenWith"
                                class="js-example-basic-multiple" multiple="multiple" onchange="this.value">
                            <c:forEach var="option" items="${option}">
